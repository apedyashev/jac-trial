// TODO: test this modules once enzyme add support for
// forwardRef: https://github.com/airbnb/enzyme/pull/1592
...
describe('<Button />', () => {
  it('should render an <a> tag if no route is specified', () => {
    ...
    // expect(renderedComponent.find(ButtonSUI).length).toEqual(1);
  });
